...
test_data, test_label = tfrecord_to_data(r'test.tfrecords')
...
train_model.fit(epochs=epochs,steps_per_epoch=int(np.ceil(60000 / float(batch_size))),verbose=1,callbacks=[EvaluateInputTensor(test_model, steps=100)])
